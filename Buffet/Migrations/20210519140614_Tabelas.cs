        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoId = table.Column<int>(nullable: true),
                    Descricao = table.Column<string>(nullable: true),
                    DataInic = table.Column<string>(nullable: true),
                    HoraInic = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Convidados_SituacaoEvento_SituacaoId",
                        column: x => x.SituacaoId,
                        principalTable: "SituacaoEvento",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
